namespace RazorEngine.Templating
{
    ...
    public class TemplateService : MarshalByRefObject, ITemplateService
    {
        ...
        public virtual string ParseAndReturnSource(string razorTemplate)
        {
            return CreateTemplateTypeAndReturnSource(razorTemplate);
        }
        ...
        public virtual string CreateTemplateTypeAndReturnSource(string razorTemplate)
        {
            return CreateTemplateTypeAndReturnSource(razorTemplate, null);
        }
        ...
        public virtual string CreateTemplateTypeAndReturnSource(string razorTemplate, Type modelType)
        {
            var context = new TypeContext
            {
                ModelType = modelType,
                TemplateContent = razorTemplate,
                TemplateType = (modelType == null) ? typeof(TemplateBase) : typeof(TemplateBase<>),
                ReplacementClassName = _config.ReplacementClassName,
                ReplacementNamespace = _config.ReplacementNamespace,
                ReplacementViewModelName = _config.ReplacementViewModelName
            };
            ...
            string result = service.CompileTypeAndReturnSource(context);
